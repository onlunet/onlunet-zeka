...
describe('FAZ 66: Gemini Secret Egress Defense', () => {
  it('1. Redacts Google AI Studio API key format (AIza...)', () => {
    const raw = 'Calling Gemini with key MOCK_GEMINI_KEY_A1B2C3D4E5F6G7H8I9J0K1L2M3N4O5P6Q';
    const sanitized = sanitizeString(raw);
    assert.ok(!sanitized.includes('MOCK_GEMINI_KEY_A1B2C3D4E5F6G7H8I9J0K1L2M3N4O5P6Q'));
  ...
  it('2. Redacts x-goog-api-key in HTTP header scrubbing', () => {
    const headers = {
      ...
      'x-goog-api-key': 'MOCK_GEMINI_KEY_A1B2C3D4E5F6G7H8I9J0K1L2M3N4O5P6Q',
  ...
  it('3. Redacts secrets from error messages and stack traces', () => {
    const err = new Error('HTTP 401: Unauthorized with MOCK_GEMINI_KEY_A1B2C3D4E5F6G7H8I9J0K1L2M3N4O5P6Q');
    const cleaned = sanitizeError(err);
    assert.ok(!cleaned.message.includes('MOCK_GEMINI_KEY_A1B2C3D4E5F6G7H8I9J0K1L2M3N4O5P6Q'));
